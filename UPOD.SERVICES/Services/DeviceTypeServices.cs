...
namespace UPOD.SERVICES.Services
{
    ...
    public class DeviceTypeServices : IDeviceTypeService
    {
        private readonly Database_UPODContext _context;
        public DeviceTypeServices(Database_UPODContext context)
        {
            _context = context;
        }
        ...
        public async Task<ObjectModelResponse> CreateDeviceType(DeviceTypeRequest model)
        {
            ...
            while (true)
            {
                var code_dup = await _context.DeviceTypes.Where(a => a.Code.Equals(code)).FirstOrDefaultAsync();
                if (code_dup == null)
                {
                    break;
                }
